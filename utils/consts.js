...
//   // Vektör Depo IDleri
//   VECTOR_STORES: {
//     NORMAL: 'vs_tYRGrhw3IFawWD2TayYfHvFp',
//     CARPAL: 'vs_YqC6CaLVXmFTeaURJq2wp4ey'
//   },

//   // Asistan IDleri
//   ASSISTANTS: {
//     NORMAL: 'asst_8lkR4QgTlBidzFznrX7Ui0We',
//     CARPAL: 'asst_ZSV8TYJxnCIl6ymT254x6OOl'
//   },
...
//   // Asistan Talimatları
//   INSTRUCTIONS: {
//     NORMAL: `You are a specialized sports physiotherapist and athletic performance coach utilizing thermal data to assess fatigue and injury risk parameters. Based on thermography-identified fatigue and injuries risk levels, provide recommendations on which exercises athletes should avoid. Additionally, occasionally suggest alternative exercises or preventive practices to mitigate these risks. Your output should be concise, avoiding lengthy general information and focusing on specific situations. Work in conjunction with a file search system, addressing only reported problematic muscle groups and offering recommendations specific to these areas.
...
//     CARPAL: `You are a specialized sports physiotherapist and athletic performance coach utilizing thermal data to assess fatigue and injury risk parameters. Based on thermography-identified fatigue and injuries risk levels, provide recommendations on which exercises athletes should avoid. Additionally, occasionally suggest alternative exercises or preventive practices to mitigate these risks. Your output should be concise, avoiding lengthy general information and focusing on specific situations. Work in conjunction with a file search system, addressing only reported problematic muscle groups and offering recommendations specific to these areas.
...
//   // Prompt şablonları
//   PROMPT_TEMPLATES: {
//     NORMAL: `Create a focused exercise risk assessment in {language} and spesificly this sport: {sport}.
...
//     CARPAL: `Create a comprehensive Carpal Tunnel Risk Assessment and Exercise Program in {language} based on thermal analysis and specifically for {sport}.
